/*
    ...
    기본형(원시) 데이터 타입의 클래스는 첫글자를 대문자로 정의한 Pascal Class로 정의됨
...
console.log(typeof num1 === typeof num2) // F
console.log('num1 = ',num1.valueOf()); 
console.log('num2 = ', num2.valueOf());

let str1 = '자바스크립트, javaScript' // 공백도 하나의 인덱스 차지
...
console.log(str1 === str2);
// 문자로 정의하게 되면 문자 하나하나를 배열의 인덱스로 정의 그래서 위치를 String[length-1]
console.log(str1.length);
// 원본의 데이터 타입은 바뀌지 않지만 메소드로 호출이 될때만 객체 타입으로 변환
console.log(str1, typeof str1); 
